...
function exp_UnidadesdeAtencinMdicadeTercerNivel_5rule0_eval_expression(context) {
...
function exp_UnidadesdeAtencinMdicadeSegundoNivel_6rule0_eval_expression(context) {
    // "CLAVE NIVE" = 2 AND "Corredor Interoceánico Veracruz_Corredor Interoceanico Veracruz_Corredor Interoce�nico" = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.properties['CLAVE NIVE']  == 2) && (feature.properties['Corredor Interoceánico Veracruz_Corredor Interoceanico Veracruz_Corredor Interoce�nico']  == 1));
    } else {
        return ((feature['CLAVE NIVE']  == 2) && (feature['Corredor Interoceánico Veracruz_Corredor Interoceanico Veracruz_Corredor Interoce�nico']  == 1));
    }
}
