...
function exp_UnidadesdeAtencionMedicaTercerNivel_5rule0_eval_expression(context) {
    // "CLAVE NIVE" = 3 AND "Corredor Interoceanico Veracruz_Corredor Interoce�nico" = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.properties['CLAVE NIVE']  == 3) && (feature.properties['Corredor Interoceanico Veracruz_Corredor Interoce�nico']  == 1));
    } else {
        return ((feature['CLAVE NIVE']  == 3) && (feature['Corredor Interoceanico Veracruz_Corredor Interoce�nico']  == 1));
    }
}


function exp_UnidadesdeAtencionMedicaSegundoNivel_6rule0_eval_expression(context) {
...
function exp_UnidadesdeAtencionMedicaPrimerNivel_7rule0_eval_expression(context) {
    // "CLAVE NIVE" = 1 AND "Corredor Interoceanico Veracruz_Corredor Interoce�nico" = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.properties['CLAVE NIVE']  == 1) && (feature.properties['Corredor Interoceanico Veracruz_Corredor Interoce�nico']  == 1));
    } else {
        return ((feature['CLAVE NIVE']  == 1) && (feature['Corredor Interoceanico Veracruz_Corredor Interoce�nico']  == 1));
    }
}
